...
class CartRestaurant extends StatefulWidget{
  ...
  String student_id;  
  CartRestaurant({Key key,this.student_id}) : super(key:key);
  
  @override
  _CartRestaurant createState() => _CartRestaurant();
  
} 

class _CartRestaurant extends State<CartRestaurant>{
                                             ...
                                             Row(
                                               children: <Widget>[
                                                 ...
                                                 Padding(
                                                   ...
                                                   child: Text("Total: 150 Pesos",style: TextStyle(fontSize: 20,),),
                                                 )
